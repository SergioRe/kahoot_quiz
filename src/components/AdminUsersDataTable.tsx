                    ...
                    <td className="px-2 py-2">
                      <div className="flex flex-wrap gap-2">
                        ...
                        >
                          ...
                          >
                            {item.activo ? (
                              <>
                                <path d="M12 2v10" />
                                <path d="M5.1 6.1a9 9 0 1 0 13.8 0" />
                              </>
                            ) : (
                              <>
                                <path d="M12 2v10" />
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1 rounded-lg bg-indigo-600 px-3 py-1.5 text-xs font-semibold text-white transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-60"
                        >
                          <svg
                            aria-hidden="true"
                            viewBox="0 0 24 24"
                          ...
                          >
                            {item.rol === 'admin' ? (
                              ...
                              <>
                                <path d="M12 3l2.7 5.5L21 9.4l-4.5 4.4L17.6 20 12 17.1 6.4 20l1.1-6.2L3 9.4l6.3-.9L12 3Z" />
                              </>
                            )}
                          </svg>
                          <span>{item.rol === 'admin' ? 'Quitar admin' : 'Hacer admin'}</span>
                        </button>
                      </div>
                    </td>
                  </tr>
