          ...
          <aside className="h-fit rounded-2xl border border-slate-200 bg-white/80 p-4">
            <div className="flex items-center justify-between gap-2">
              ...
              <div ref={accountMenuRef} className="relative w-auto">
                ...
                {isAccountMenuOpen && (
                  <div className="absolute right-0 top-full z-30 mt-2 grid w-[min(92vw,340px)] max-w-[calc(100vw-2rem)] gap-2 rounded-xl border border-slate-200 bg-white p-3 shadow-xl">
                  <button
                    type="button"
                    onClick={() => {
                      navigate('/perfil')
